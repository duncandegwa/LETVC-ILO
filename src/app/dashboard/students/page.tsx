      ...
      >
        <form onSubmit={form.handleSubmit(handleSave)} className="space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Input label="Admission Number" {...form.register('admission_number')} error={form.formState.errors.admission_number?.message} required placeholder="e.g. AP/J25/001" />
            ...
            <Input label="Phone Number" {...form.register('phone_number')} error={form.formState.errors.phone_number?.message} required placeholder="+2547000000000" />
            ...
            <Input label="Class" {...form.register('class_name')} error={form.formState.errors.class_name?.message} required placeholder="e.g. CFB/S24" />
